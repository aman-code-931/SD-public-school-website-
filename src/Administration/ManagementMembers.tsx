            ...
            <table className="w-full text-left">
              ...
              <thead className="bg-[#0f2550] text-white">
                <tr>
                  ...
                  <th className="p-4">Name of the member</th>
              ...
              <tbody className="text-gray-700">
                ...
                {[
                  ["1.", "Sh. P. K. Aggarwal", "CHAIRMAN"],
                  ["2.", "Sh. Subhash Khandelwal", "PRESIDENT"],
                  ["3.", "Sh. Narender Rathi", "VICE PRESIDENT"],
                  ["4.", "Sh. C. M. Bhasin", "SECRETARY"],
                  ["5.", "Sh. Uma Shankar Gupta", "MANAGER"],
                  ["6.", "Sh. Naveen Khurana", "TREASURER"],
                  ["7.", "Sh. Akhil Jindal", "MEMBER"],
                  ["8.", "Mrs Dakshita Singhal", "Principal"],
                ].map((row, index) => (
